...
public class CategoryRepository : ICategoryRepository
{
    ...
    {
        // Query
        var categories = dbContext.Categorys.AsQueryable();
    ...
    {
        return await dbContext.Categorys.FirstOrDefaultAsync(x => x.Id == id);
    }

    public async Task<int> GetCount()
    {
        return await dbContext.Categorys.CountAsync();
    }
